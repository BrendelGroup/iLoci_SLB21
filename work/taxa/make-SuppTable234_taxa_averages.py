...
pilocus_avgs.to_csv('SLB21-SuppTable2-pilocus_averages.tsv', sep = '\t', index = False)
milocus_avgs.to_csv('SLB21-SuppTable3-milocus_averages.tsv', sep = '\t', index = False)
ilocus_avgs.to_csv('SLB21-SuppTable4-ilocus_averages.tsv', sep = '\t', index = False)
